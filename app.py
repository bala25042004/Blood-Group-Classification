...
def setup_app():
    ...
    if not db_setup_done:
        init_db()
        # Skip auto-training on Railway - models should be pre-trained
        print("App initialized. Waiting for user uploads.")
        db_setup_done = True
        ...
        if file:
            ...
            try:
                ...
                return jsonify({
                    ...
                    'message': 'Fundus image processed successfully'
                })
        ...
        if file:
            ...
            try:
                ...
                return jsonify({
                    ...
                    'features': features,
                    'processed_image_path': processed_image_path,
                    'message': 'Sclera image processed successfully'
                })
            except Exception as e:
                return jsonify({'error': str(e)})
...
def results():
    ...
    predicted_blood_group = "Model not available - please train locally"
